/**
 * Chain with multiple iterations.
 */
...
public class Driver_Chain2 extends Configured implements Tool {

	
	public static void main(String[] args) throws Exception{
		//Driver_Basic_Chain2.job1();
		//Driver_Basic_Chain2.job2();
		ToolRunner.run(new Configuration(), new Driver_Chain2(), args);
	}
	...
	public int run(String[] args) throws Exception {
		...
		job1.setJarByClass(Driver_Chain2.class);
		...
		for(int i=1; i < 4; i++){
			...
			job2.setJarByClass(Driver_Chain2.class);
